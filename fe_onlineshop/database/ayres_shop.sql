...
-- Sample products
INSERT INTO `products` (`category_id`, `brand_id`, `name`, `slug`, `base_price`, `stock`, `status`, `has_variant`, `weight_grams`, `description`, `total_sold`, `published_at`) VALUES
(1, 1, 'Essential Cotton Tee', 'essential-cotton-tee', 299000.00, 150, 'live', 1, 200, 'Premium cotton t-shirt with relaxed fit. Made from 100% organic cotton for everyday comfort.', 234, NOW()),
(1, 1, 'Oversized Linen Shirt', 'oversized-linen-shirt', 459000.00, 80, 'live', 1, 250, 'Breathable linen shirt with oversized silhouette. Perfect for layering or worn on its own.', 156, NOW()),
(2, 1, 'Tailored Wide Leg Trousers', 'tailored-wide-leg-trousers', 599000.00, 60, 'live', 1, 400, 'High-waisted wide leg trousers with clean lines. Crafted from premium wool blend.', 89, NOW()),
(2, 1, 'Relaxed Chino Pants', 'relaxed-chino-pants', 449000.00, 100, 'live', 1, 350, 'Classic chino with relaxed fit and tapered leg. Versatile wardrobe essential.', 178, NOW()),
(3, 1, 'Wool Blend Overcoat', 'wool-blend-overcoat', 1299000.00, 30, 'live', 1, 900, 'Timeless double-breasted overcoat in premium wool blend. Refined tailoring for modern elegance.', 45, NOW()),
(4, 1, 'Midi Wrap Dress', 'midi-wrap-dress', 549000.00, 45, 'live', 1, 300, 'Elegant wrap dress with midi length. Fluid drape and flattering silhouette.', 112, NOW()),
(5, 1, 'Leather Minimal Belt', 'leather-minimal-belt', 249000.00, 200, 'live', 0, 150, 'Minimalist leather belt with brushed metal buckle. Full-grain Italian leather.', 320, NOW()),
(5, 1, 'Canvas Tote Bag', 'canvas-tote-bag', 349000.00, 70, 'live', 0, 500, 'Oversized canvas tote with leather handles. Spacious interior with zip pocket.', 198, NOW());

-- Variants for Essential Cotton Tee
INSERT INTO `product_variants` (`product_id`, `option_name_1`, `option_value_1`, `option_name_2`, `option_value_2`, `price`, `stock`) VALUES
(1, 'Color', 'Black', 'Size', 'S', 299000.00, 25),
(1, 'Color', 'Black', 'Size', 'M', 299000.00, 30),
(1, 'Color', 'Black', 'Size', 'L', 299000.00, 20),
(1, 'Color', 'White', 'Size', 'S', 299000.00, 25),
(1, 'Color', 'White', 'Size', 'M', 299000.00, 30),
(1, 'Color', 'White', 'Size', 'L', 299000.00, 20),
(2, 'Color', 'Cream', 'Size', 'M', 459000.00, 20),
(2, 'Color', 'Cream', 'Size', 'L', 459000.00, 20),
(2, 'Color', 'Navy', 'Size', 'M', 459000.00, 20),
(2, 'Color', 'Navy', 'Size', 'L', 459000.00, 20),
(3, 'Color', 'Charcoal', 'Size', 'S', 599000.00, 15),
(3, 'Color', 'Charcoal', 'Size', 'M', 599000.00, 15),
(3, 'Color', 'Charcoal', 'Size', 'L', 599000.00, 15),
(3, 'Color', 'Beige', 'Size', 'M', 599000.00, 15),
(4, 'Color', 'Khaki', 'Size', 'M', 449000.00, 25),
(4, 'Color', 'Khaki', 'Size', 'L', 449000.00, 25),
(4, 'Color', 'Black', 'Size', 'M', 449000.00, 25),
(4, 'Color', 'Black', 'Size', 'L', 449000.00, 25),
(5, 'Color', 'Black', 'Size', 'M', 1299000.00, 10),
(5, 'Color', 'Black', 'Size', 'L', 1299000.00, 10),
(5, 'Color', 'Camel', 'Size', 'M', 1299000.00, 5),
(5, 'Color', 'Camel', 'Size', 'L', 1299000.00, 5),
(6, 'Color', 'Olive', 'Size', 'S', 549000.00, 15),
(6, 'Color', 'Olive', 'Size', 'M', 549000.00, 15),
(6, 'Color', 'Black', 'Size', 'S', 549000.00, 15);
